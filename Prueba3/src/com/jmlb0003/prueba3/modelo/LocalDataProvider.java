...
public class LocalDataProvider {
    ...
    public List<Marker> getMarkers() {
    	Marker atl = new Marker("ATL", 39.931269, -75.051261, 0, Color.DKGRAY, sIcon, sSelectedIcon);
        cachedMarkers.add(atl);

        Marker home = new Marker("Casa", 37.6759861, -3.5661972, 763.0, Color.YELLOW);
        cachedMarkers.add(home);

        Marker picoMagina = new Marker("Magina", 37.725048, -3.466663, 2132.0, Color.DKGRAY, sIcon, sSelectedIcon);
        cachedMarkers.add(picoMagina);
        
        Marker cortijo = new Marker("cortijo", 37.692997,-3.565028, 912.0, Color.DKGRAY, sIcon, sSelectedIcon);
        cachedMarkers.add(cortijo);
        
        
        Marker carcheles = new Marker("carcheles", 37.644594, -3.638578, 825.0, Color.DKGRAY, sIcon, sSelectedIcon);
