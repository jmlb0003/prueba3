 ...
 *
 */
public class SeekBarPreferencias extends Preference implements OnSeekBarChangeListener {
	 ...
	 * @param context
	 */
	public SeekBarPreferencias(Context context) {
		this(context,null);
	}
	 ...
	 * @param attrs
	 */
	public SeekBarPreferencias(Context context, AttributeSet attrs) {		
		super(context, attrs);
	 ...
	 * @param defStyle
	 */
	public SeekBarPreferencias(Context context, AttributeSet attrs, int defStyle) {
